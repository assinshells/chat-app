...
// показується у палітрі вибору (LoginForm.jsx).
//
...
// або, навпаки, стає надто сліпучим на ньому (жовтий, білий) - освітлені
// чи притлумлені варіанти лишаються впізнаваними в обох темах. Для
...
export const COLOR_OPTIONS = Object.freeze([
  ...
  { value: "white", hex: "#f8f9fa", hexDark: "#ffffff", label: "Білий" },
...
/**
 * getVisibleColorOptions - список для рендеру самої палітри (LoginForm.jsx),
 ...
 * для початкового стану форми входу (LoginForm.jsx) - на бекенді
 * DEFAULT_COLOR лишається 'black', бо форма завжди явно надсилає
 * обране значення в PATCH /api/auth/color.
 */
